...
let TEXT_SIGNIN_HEADLINE = "Presentgram"
let TEXT_SIGNIN_SUBHEADLINE = "The easeiest way to share your products with costumers"
let TEXT_SIGNUP_NOTE = "An account will allow you to save and access photo information across devices."
let TEXT_SIGNUP_PASSWORD_REQUIRED = "At least 8 characters required"


let IMAGE_LOGO = "present"
let IMAGE_USER_PLACEHOLDER = "user-placeholder"
let IMAGE_PHOTO = "plus.circle"

class Ref {
    //Storage
    static var STORAGE_ROOT = Storage.storage().reference(forURL: "gs://letslearntogetherbagrut.appspot.com")
